...
public class UserManageVO extends UserDefaultVO{
	...
	// 소속과 : 소속과 혹은 산하기관의 소분류 코드
	private String pstinstMidCode;
	...
	private String orgSc;
	private String groupNm;	
	private String codeNm;
	private String codeNmOrg;
	...
	public String getPstinstMidCode() {
		return pstinstMidCode;
	}
	public void setPstinstMidCode(String pstinstMidCode) {
		this.pstinstMidCode = pstinstMidCode;
	}
	...
	public String getOrgSc() {
		return orgSc;
	}
	public void setOrgSc(String orgSc) {
		this.orgSc = orgSc;
	}
	...
	public String getCodeNmOrg() {
		return codeNmOrg;
	}
	public void setCodeNmOrg(String codeNmOrg) {
		this.codeNmOrg = codeNmOrg;
	}
