    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<c:url value="main.do"/>">
                ...
                <div class="sidebar-brand-text mx-3"><p class="mainText">비숲</p></div>
            </a>
          ...
          <%--   <div class="sidebar-card d-none d-lg-flex">
                <img class="sidebar-card-illustration mb-2" src="<c:url value="/css/bootstrapthema/img/undraw_rocket.svg"/>" alt="...">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="<c:url value="/css/bootstrapthema/img/undraw_profile_1.svg"/>"
                                            alt="...">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="<c:url value="/css/bootstrapthema/img/undraw_profile_2.svg"/>"
                                            alt="...">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="<c:url value="/css/bootstrapthema/img/undraw_profile_3.svg"/>"
                                            alt="...">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="<c:url value="/css/bootstrapthema/img/undraw_profile.svg"/>">
                            </a>
                                ...
                                <div class="card-body">
                                    <div class="text-center">
                                        <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;"
                                            src="<c:url value="/css/bootstrapthema/img/undraw_posting_photo.svg"/>" alt="...">
                                    </div>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Mapo Website 2021</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
